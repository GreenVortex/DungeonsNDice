...
function Dice() {
    setTimeout(() => {
        document.getElementById("Dice").classList.remove('animate__wobble');
        NumGen();
    }, 2000);
...
function D4() {
    DiceNumber = 4;
    setTimeout(() => {
        document.getElementById("D4").classList.remove('animate__tada');
    }, 1000);
...
function D6() {
    DiceNumber = 6;
    setTimeout(() => {
        document.getElementById("D6").classList.remove('animate__tada');
    }, 1000);
...
function D8() {
    DiceNumber = 8;
    setTimeout(() => {
        document.getElementById("D8").classList.remove('animate__tada');
    }, 1000);
...
function D10() {
    DiceNumber = 10;
    setTimeout(() => {
        document.getElementById("D10").classList.remove('animate__tada');
    }, 1000);
...
function D12() {
    DiceNumber = 12;
    setTimeout(() => {
        document.getElementById("D12").classList.remove('animate__tada');
    }, 1000);
...
function D20() {
    DiceNumber = 20;
    setTimeout(() => {
        document.getElementById("D20").classList.remove('animate__tada');
    }, 1000);
